	...
	<div class = "col-md-12">
		<div class = "loginPass">
    		...
    		<input type="password" class="form-control" id="exampleInputPassword3" placeholder="Password">
  			...
  			<button type="submit" class="btn btn-default regLink">Register</button>
  			
			</form>
			<div class = "h3 text-center"><c:if test="${sessionScope.regresult}"> "Sorry, this login is incorrect, try anotherone" </c:if></div>
		</div>		
